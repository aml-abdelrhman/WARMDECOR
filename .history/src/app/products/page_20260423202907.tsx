...
function ProductsContent() {
  ...
  // تحديث الحالة المحلية عند تغيير الرابط (مثلاً عند الضغط على زر الرجوع في المتصفح)
  useEffect(() => {
  ...
  function handleSearchChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setSearchInput(val);
    // إذا أردت السماح بالبحث داخل القسم الحالي، احذف السطر أعلاه.
    // أما إذا أردت البحث العام كما هو الآن، فاتركه.
    resetPage();
  }
              ...
              >
                <ProductCard
                  ...
                  onAddToCart={() => {
                    ...
                    // تأكد من تمرير المعرف بالشكل الذي يتوقعه الـ Hook (غالباً كـ string أو كائن)
